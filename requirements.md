...
- 使用樱花粉色系和柔和渐变
- 全站背景使用 `public/images/site-bg.jpg`
- 背景定位优先展示人物头部，同时用遮罩保证文字可读，并让背景人物主体避开右侧个人名片区域；桌面端应让人物主体明显左移到名片左侧，减少遮挡
- 顶部 Banner / Hero 使用柔和渐变，不再直接裁切背景人物图
- 首页 `/` 直接展示博客文章列表，不再保留大块 Banner、公告卡或最新文章推荐区作为首屏主内容
...
- `public/images/site-bg.jpg`：全站背景图
